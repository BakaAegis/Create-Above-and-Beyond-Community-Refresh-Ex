StartupEvents.registry('block', event => {
	...
	reagent(0x27A9BB, 0x2CC7C9, "apatite", "thermal:apatite")
	reagent(0xC7A94A, 0xEEF071, "sulfur", "thermal:sulfur")
	reagent(0x735A65, 0xB8AFAF, "niter", "thermal:niter")
	reagent(0x91C5FC, 0xA7CBCF, "certus", "ae2:certus_quartz_dust")
	reagent(0xB19E8F, 0xE7E2DB, "quartz", "mekanism:dust_quartz")
	category()
	reagent(0x616A60, 0xD0D2C5, "zinc", "kubejs:zinc_dust")
	reagent(0xDD7E5D, 0xFCEFBA, "copper", "mekanism:dust_copper")
	reagent(0xA6A6A6, 0xD5D5D5, "iron", "mekanism:dust_iron")
	reagent(0x977756, 0xE4D196, "nickel", "thermal:nickel_dust")
	reagent(0x232456, 0x7C95A4, "lead", "thermal:lead_dust")
	reagent(0xD99413, 0xFAF25E, "gold", "mekanism:dust_gold")
	category()
	reagent(0xFC7781, 0xFCCED0, "cinnabar", "thermal:cinnabar")
	reagent(0x335DC1, 0x7395E7, "lapis", "mekanism:dust_lapis_lazuli")
	reagent(0x246BE9, 0x76C6FC, "sapphire", "thermal:sapphire_dust")
	reagent(0x00A82B, 0xADFACB, "emerald", "mekanism:dust_emerald")
	reagent(0x9D0A33, 0xFB7B71, "ruby", "thermal:ruby_dust")
	reagent(0x20C3B3, 0xD2FCF3, "diamond", "mekanism:dust_diamond")
	category()
